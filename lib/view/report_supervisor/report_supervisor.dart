...
import 'package:repair_app/view/report_supervisor/report_supervisor_controller.dart';
import 'package:repair_app/widgets/custom_page_container.dart';

class ReportSupervisor extends GetView<ReportSupervisorController> {
  const ReportSupervisor({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(ReportSupervisorController());
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) => Scaffold(
        key: controller.reportSupervisorKey,
        appBar: AppBar(
          centerTitle: true,
          toolbarHeight: 260.h,
          elevation: 0,
